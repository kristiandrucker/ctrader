...
func file_OpenApiMessages_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_OpenApiMessages_proto_msgTypes[89].Exporter = func(v any, i int) any {
		...
		file_OpenApiMessages_proto_msgTypes[90].Exporter = func(v any, i int) any {
		...
		file_OpenApiMessages_proto_msgTypes[91].Exporter = func(v any, i int) any {
		...
		file_OpenApiMessages_proto_msgTypes[92].Exporter = func(v any, i int) any {
		...
		file_OpenApiMessages_proto_msgTypes[93].Exporter = func(v any, i int) any {
